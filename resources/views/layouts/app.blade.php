...
<div class="bg-gray-100 flex flex-col justify-between mb-20 lg:mb-16">
    ...
    <footer class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 border-2">
        ...
        <div class="flex justify-center lg:justify-end items-center mx-auto py-4 lg:py-6 px-4 sm:px-6 lg:px-8">
            <div class="mr-4">
                @livewire('check-sites-button')
            </div>
            <div>
                <a href="/"
                   class="inline-flex items-center hover:text-blue-600 transition-colors duration-200 ease-in-out">
                    Documentation
